...
def upgrade():
    ...
    sa.Column('distribution', postgresql.ENUM('ORGANISATION_ONLY', 'COMMUNITY_ONLY', 'CONNECTED_COMMUNITIES', 'ALL_COMMUNITIES', 'SHARING_GROUP', 'INHERIT_EVENT', name='distribution_level'), nullable=False),

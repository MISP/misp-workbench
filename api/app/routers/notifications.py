...
@router.get(
    "/notifications/me",
    response_model=list[notification_schemas.Notification],
)
...
) -> list[notification_schemas.Notification]:
    return notifications_repository.get_user_notifications(db, user_id=user.id)

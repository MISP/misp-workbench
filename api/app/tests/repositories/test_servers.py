        ...
        "Event": {
            ...
            "Attribute": [
                ...
                },
                {
                    ...
                    "category": "Network activity",
                    "to_ids": False,
                    "uuid": "f2f971c6-c921-46fc-941d-4f91106fb3b2",
                    "event_id": "1",
                    "distribution": "5",
                    "timestamp": "1655129114",
                    "comment": "",
                    "sharing_group_id": "0",
                    "deleted": False,
                    "disable_correlation": False,
    ...
    def test_full_pull_server_by_id(
        ...
        with patch(
            ...
            mock_misp_client.return_value = MagicMock(
                ...
                search_index=MagicMock(return_value=self.mock_event_search_response),
                # raw event parsing
                _check_json_response=MagicMock(return_value=self.mock_event),
                # /events/view/{event_uuid}
                _prepare_request=MagicMock(return_value=self.mock_event),
            )

...
AVAILABLE_SCOPES: dict[str, str] = {
        ...
        "analyst_data:create": "Create analyst data (notes, opinions, relationships).",
        "analyst_data:update": "Update analyst data (notes, opinions, relationships).",
        "analyst_data:delete": "Delete analyst data (notes, opinions, relationships).",
        ...
        "hunts:run": "Run hunts.",
        "exports:create": "Create IOC exports.",
        "exports:read": "Read and download IOC exports.",
        "exports:delete": "Delete IOC exports.",
        ...
        "servos:read": "Read Tech Lab transformation servos and ingest pipelines.",

...
def upgrade():
    ...
    op.create_index(op.f('ix_attributes_value1'), 'attributes', ['value1'], unique=False)
    op.create_index(op.f('ix_attributes_value2'), 'attributes', ['value2'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_attributes_value2'), table_name='attributes')
    op.drop_index(op.f('ix_attributes_value1'), table_name='attributes')

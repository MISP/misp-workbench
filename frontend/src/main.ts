...
import { faPen, faEye, faTrash, faAngleUp, faAngleDoubleUp, faAngleDown, faAngleDoubleDown, faCopy, faBars, faEnvelopeOpenText, faBuilding, faUsers, faServer, faArrowRightFromBracket, faDownLong, faUpLong, faTags, faTag, faShapes, faCubesStacked, faArrowUp, faArrowDown, faCheck, faCheckDouble, faSync, faNetworkWired, faFileLines, faLink, faQuestion, faMoneyCheckDollar, faPerson, faSkullCrossbones, faCircleInfo, faFloppyDisk, } from '@fortawesome/free-solid-svg-icons'
library.add(faPen, faEye, faTrash, faAngleUp, faAngleDoubleUp, faAngleDown, faAngleDoubleDown, faCopy, faBars, faEnvelopeOpenText, faBuilding, faUsers, faServer, faArrowRightFromBracket, faDownLong, faUpLong, faTags, faTag, faShapes, faCubesStacked, faArrowUp, faArrowDown, faCheck, faCheckDouble, faSync, faNetworkWired, faFileLines, faLink, faQuestion, faMoneyCheckDollar, faPerson, faSkullCrossbones, faCircleInfo, faFloppyDisk);

...
export const ATTRIBUTE_CATEGORIES = {
  ...
  "Antivirus detection": {
    description:
      "All the info about how the malware is detected by the antivirus products",
  ...
  Attribution: {
    description:
      "Identification of the group, organisation, or country behind the attack",
    help: "",
    types: [
      "threat-actor",
      "campaign-name",
  ...
  "External analysis": {
    description:
      "Any other result from additional analysis of the malware like tools output",
  ...
  Other: {
    description:
      "Attributes that are not part of any other category or are meant to be used as a component in MISP objects in the future",
    help: "",

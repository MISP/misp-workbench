...
const feedRules = ref(JSON.stringify(feed.value.rules || {}, null, 2));
const feedSettings = ref(JSON.stringify(feed.value.settings || {}, null, 2));
...
function handleDistributionLevelUpdated(distributionLevel) {
    feed.distribution = distributionLevel;
}
            ...
            <Form @submit="updateFeed" :validation-schema="FeedSchema" v-slot="{ errors, isSubmitting }">
                ...
                <div class="collapse" id="advancedSettings">
                    ...
                    <div class="mb-3">
                        ...
                        <Field class="form-control" id="feed.fixed_event" name="feed.fixed_event"
                            :value="feed.fixed_event" v-model="feed.fixed_event"
                    ...
                    <div class="mb-3">
                        ...
                        <Field class="form-control" id="feed.delta_merge" name="feed.delta_merge"
                            :value="feed.delta_merge" v-model="feed.delta_merge"
